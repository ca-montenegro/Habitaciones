...
insert into APP.USUARIOENTITY (NUMEROID, DTYPE, CONTRASENHA, CORREO, DIRECCION, NOMBRE, NUMEROTARJETA, TELEFONO, TIPOID, USUARIO, PUNTUACION, IMAGE) values (123456, 'c', '1234','jaime@jaime.com','jaime #43-3', 'Jaime Chavarriaga', 12345567, 12345678, 'CC', 'JaimeAdmin', 10, 'https://lh4.googleusercontent.com/wa2V6epYXex28Teeo1UcNX37zdPBqOJZBnK1EbJVwRSEAhtGSy6EYSyu-9Vu0dk21tSHR6HMUyO7stc=w1280-h739');
