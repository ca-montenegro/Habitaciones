...
insert into APP.USUARIOENTITY (NUMEROID, DTYPE, CONTRASENHA, CORREO, DIRECCION, NOMBRE, NUMEROTARJETA, TELEFONO, TIPOID, USUARIO, PUNTUACION, IMAGE) values (123456, 'c', '1234','jaime@jaime.com','jaime #43-3', 'Jaime Chavarriaga', 12345567, 12345678, 'CC', 'JaimeAdmin', 10, 'https://lh6.googleusercontent.com/6SF0MXgf1u4DkqFm4KBzABSHPEE3c55KsSDOdNff9xWepaTpzaZowMj-8l1lXvff1y5hQMlBZvtrIAM=w5120-h2758');
